<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    id="sidenav-main" style="z-index: 1030;">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <x-sidebar-item 
                ...
                title="Dashboard"
                :isActive="Route::currentRouteName() == 'dashboard'"
                :icon="'<title>shop </title>
            ...
            <x-sidebar-header title="Laravel Examples" />

            <x-sidebar-item 
                route="{{ route('user-profile') }}"
                title="User Profile"
                :isActive="Route::currentRouteName() == 'user-profile'"
                :icon="'<title>customer-support</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
            ...
            <x-sidebar-item 
                ...
                :isActive="Route::currentRouteName() == 'user-management'"
                :isCustomIcon="true"
                :icon="'<title>user-management</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
                        <g transform=\'translate(-1717.000000, -291.000000)\' fill=\'#FFFFFF\' fill-rule=\'nonzero\'>
                            <g transform=\'translate(1716.000000, 291.000000)\'>
                                <g transform=\'translate(1.000000, 0.000000)\'>
...
{{-- 
            ...
            {{-- <x-sidebar-item 
                route="{{ route('tables') }}"
                title="Tables"
                :isActive="Route::currentRouteName() == 'tables'"
                :icon="'<title>office</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
            ...
            /> --}}
             ...
             <x-sidebar-item 
                route="{{ route('buttons.sample-buttons') }}"
                title="Buttons"
                :icon="'<title>spaceship</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
            ...
            />
            <x-sidebar-item 
                route="{{ route('inputs.sample-inputs') }}"
                title="Inputs"
                :icon="'<title>spaceship</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
                        <g transform=\'translate(-1720.000000, -592.000000)\' fill=\'#FFFFFF\' fill-rule=\'nonzero\'>
            ...
            />
            <x-sidebar-item 
                route="{{ route('table.sample-table') }}"
                title="Table"
                :isActive="Route::currentRouteName() == 'tables'"
                :icon="'<title>office</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
            ...
            />
            <x-sidebar-item 
                route="{{ route('alert.sample-alert') }}"
                title="Alerts"
                :isActive="Route::currentRouteName() == 'tables'"
                :icon="'<title>office</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
            ...
            <x-sidebar-item 
                route="{{ route('billing') }}"
                title="Billing"
                :isActive="Route::currentRouteName() == 'billing'"
                :icon="'<title>credit-card</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
            ...
            <x-sidebar-item 
                route="{{ route('rtl') }}"
                title="RTL"
                :isActive="Route::currentRouteName() == 'rtl'"
            ...
            <x-sidebar-item 
                route="{{ route('profile') }}"
                title="Profile"
                :isActive="Route::currentRouteName() == 'profile'"
                :icon="'<title>customer-support</title>
                    <g stroke=\'none\' stroke-width=\'1\' fill=\'none\' fill-rule=\'evenodd\'>
                        <g transform=\'translate(-1717.000000, -291.000000)\' fill=\'#FFFFFF\' fill-rule=\'nonzero\'>
                            <g transform=\'translate(1716.000000, 291.000000)\'>
